...
public interface SubmissionDAO {
    ...
    @Results({
            ...
            @Result(property = "problem", column = "problem_id", javaType = Problem.class, one = @One(select = "com.bohuanshi.oj.dao.getProblem")),
            @Result(property = "uid", column = "uid"),
            @Result(property = "language", column = "language_id", javaType = Language.class, one = @One(select = "com.bohuanshi.oj.dao.getLanguageUsingId")),
